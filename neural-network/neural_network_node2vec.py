...
class NeuralNetwork(nn.Module):
	def __init__(self):
		...
		self.d1 = nn.Linear(66, 50)
		self.d2 = nn.Linear(50, 1)
...
train_data = FacebookDataset("../data/node2vec_train_filtered.data")
train_dataloader = DataLoader(train_data, batch_size=50, shuffle=True, num_workers=2)

test_data = FacebookDataset("../data/node2vec_test_filtered.data")
test_dataloader = DataLoader(test_data, batch_size=50, shuffle=True, num_workers=2)

unseen_data = FacebookDataset("../unseen-data/node2vec_unseen_filtered.data")
