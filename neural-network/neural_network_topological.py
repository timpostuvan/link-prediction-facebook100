...
class NeuralNetwork(nn.Module):
	def __init__(self):
		...
		self.d1 = nn.Linear(9, 5)
		self.d2 = nn.Linear(5, 1)
...
train_data = FacebookDataset("../data/topological_train_filtered.data")
train_dataloader = DataLoader(train_data, batch_size=50, shuffle=True, num_workers=2)

test_data = FacebookDataset("../data/topological_test_filtered.data")
test_dataloader = DataLoader(test_data, batch_size=50, shuffle=True, num_workers=2)

unseen_data = FacebookDataset("../unseen-data/topological_unseen_filtered.data")
